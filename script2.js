...
const pressHoldHeart = document.getElementById("press-hold-heart");
let holdTimer;

pressHoldHeart.addEventListener("mousedown", () => {
...
["mouseup", "mouseleave", "touchend", "touchcancel"].forEach(event =>
  pressHoldHeart.addEventListener(event, () => clearTimeout(holdTimer))
);
